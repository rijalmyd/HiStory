...
class PasswordEditText : AppCompatEditText {
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (!isValidPassword(s)) error = context.getString(R.string.error_password)
            }
    ...
    private fun isValidPassword(password: CharSequence?) = if (password.isNullOrEmpty()) false else password.length >= 6
}